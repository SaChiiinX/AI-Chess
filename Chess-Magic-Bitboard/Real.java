...
public class Real extends Player{
    ...
    public Move getMove(Scanner input){
        ...
        String moveRegex = "[PNRBQK][A-H][1-8][A-H][1-8]";
        String userChoice = "";
        ...
        while(attempts < maxAttempts){
            ...
            if(Pattern.matches(moveRegex, userChoice)){
                ...
                piece = game.getTurn() ? (short)Utility.getPieceIndex(userChoice.charAt(0)) : (short)-Utility.getPieceIndex(userChoice.charAt(0));
