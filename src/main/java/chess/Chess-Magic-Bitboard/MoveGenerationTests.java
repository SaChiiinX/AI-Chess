...
public class MoveGenerationTests {
    ...
    public void whiteDouble1(){
        ...
        MoveSet moves = GenerateMoves.generatePawnMoveTwoSquares(true, wStarting, opponents);
    ...
    public void whiteCR1(){
        ...
        MoveSet moves = GenerateMoves.generatePawnCapturingRight(true, wStarting, opponents);
    ...
    public void whiteCL1(){
        ...
        MoveSet moves = GenerateMoves.generatePawnCapturingLeft(true, wStarting, opponents);
    ...
    public void whiteSingle1(){
        ...
        MoveSet moves = GenerateMoves.generatePawnMoveOneSquare(true, pawns, opponents);
    ...
    public void blackDouble1(){
        ...
        MoveSet moves = GenerateMoves.generatePawnMoveTwoSquares(false, bStarting, opponents);
    ...
    public void blackCR1(){
        ...
        MoveSet moves = GenerateMoves.generatePawnCapturingRight(false, bStarting, opponents);
    ...
    public void blackCL1(){
        ...
        MoveSet moves = GenerateMoves.generatePawnCapturingLeft(false, bStarting, opponents);
    ...
    public void blackSingle1(){
        ...
        MoveSet moves = GenerateMoves.generatePawnMoveOneSquare(false, pawns, opponents);
